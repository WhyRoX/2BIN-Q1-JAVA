...
public class ExerciceGroupingBy {
    ...
    private void groupBy1() {
        ...
        var s = transactions.stream().collect(Collectors.groupingBy(Transaction::getTrader));
    ...
    private void groupBy3() {
        ...
        var s = transactions
                ...
                .collect(Collectors.groupingBy(e -> {
                    if (e.getValue() >= 1000 ) return TransactionsLevel.VERY_HI;
                    else if (e.getValue() >= 800) return TransactionsLevel.HI;
                    else if (e.getValue() >= 600) return TransactionsLevel.ME;
